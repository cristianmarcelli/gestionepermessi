			                	...
			                	<c:forEach items="${utenti_list_attribute }" var="utenteItem">
									<tr>
										...
										<td>
											...
											<a id="resetPasswordLink_#_${utenteItem.id }" class="btn btn-sm btn-outline-danger btn-sm link-for-modal" data-bs-toggle="modal" data-bs-target="#confirmOperationModalPassword"  >Reset Password</a>
										</td>
									</tr>
								</c:forEach>
			                </tbody>
